...
if st.sidebar.button('How to use'):
    ...
    c1.image('D:\Projects\WhatsAppChatAnalyzer\static\images\image01.jpeg')
    c2.markdown("step 2:- Click on the more option.")
    c2.image("static/images/image02.jpeg")
    c3.markdown("step 3 :- Click on Export chat option.")
    c3.image("D:\Projects\WhatsAppChatAnalyzer\static\images\image03.jpeg")
    c4.markdown("step 4 :- Select option 'without media'.")
    c4.image("D:\Projects\WhatsAppChatAnalyzer\static\images\image04.jpeg")
